...
import ProductCardSecondary from "@/_components/ProductCard/ProductCardSecondary";
import ProductCardCarouselProps from "@/_components/ProductCardCarousel/ProductCardCarousel.interface";

const ProductCardCarouselSecondary = ({
  cardsContent,
...
export default ProductCardCarouselSecondary;
