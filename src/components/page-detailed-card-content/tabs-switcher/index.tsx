import CardCharacteristics from "./tabs-content/card-characteristics";
import DetailedCardReviews from "./tabs-content/detailed-card-reviews";
import ProductDescription from "./tabs-content/product-description";
