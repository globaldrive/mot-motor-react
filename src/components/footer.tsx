...
import EmailSvg from "@/assets/images/general/email.svg";
import SentSvg from "@/assets/images/general/sent.svg";
import CatalogPng from "@/assets/images/pngs/catalog.png";
import ConsultantPng from "@/assets/images/pngs/consultant.png";
import PaymentOptionsPng from "@/assets/images/pngs/paymentOptions.png";
import PodvesnoyMotorPng from "@/assets/images/pngs/plm.png";
        ...
        <div className="relative mb-5 sm:mb-8">
          <div className="flex flex-col sm:flex-row gap-3 ">
            ...
            >
              ...
              <IconArrow variant="tertiary" flip={activeButton === 1} />
            </button>
            <button
            ...
            >
              ...
              <IconArrow variant="tertiary" flip={activeButton === 2} />
            </button>
          </div>
          <div
